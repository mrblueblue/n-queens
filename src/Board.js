 ...
 */
    ...
    hasRowConflictAt: function(rowIndex) {
      ...
      var numPieces = _.filter(row, function(val) {
        return val === 1;
      }).length;
    ...
    hasAnyRowConflicts: function() {
      ...
      return !!_.some(rows, function(row, index){
        return self.hasRowConflictAt(index) === true;
      });
    },
    ...
    hasMajorDiagonalConflictAt: function(majorDiagonalColumnIndexAtFirstRow) {
      ...
      _.each(this.rows(), function(row, index){
        if (majorDiagonalColumnIndexAtFirstRow + index < row.length &&
            majorDiagonalColumnIndexAtFirstRow + index >= 0){
    ...
    hasAnyMinorDiagonalConflicts: function() {
      ...
      return !!_.some(this.rows()[0], function(row, index){
        return self.hasMinorDiagonalConflictAt(index) === true;
      });
    }
